...
namespace OverviewerGUI
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            header[0] = "###########################################";
            header[1] = "#                                         #";
            header[2] = "#   This pastebin was generated by the    #";
            header[3] = "#            Overviewer GUI               #";
            header[4] = "#                                         #";
            header[5] = "#   Paste the link for this in the IRC    #";
            header[6] = "#  channel at http://overviewer.org/irc   #";
            header[7] = "#  And we'll help you with the error :)   #";
            header[8] = "#                                         #";
            header[9] = "###########################################";
        }
